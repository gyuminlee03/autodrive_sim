...
static const _SimpleLidar_type_support_symbol_names_t _SimpleLidar_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, midterm_msgs, msg, SimpleLidar)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, midterm_msgs, msg, SimpleLidar)),
  }
};
...
{
  return &::midterm_msgs::msg::rosidl_typesupport_cpp::SimpleLidar_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, midterm_msgs, msg, SimpleLidar)() {
  return get_message_type_support_handle<midterm_msgs::msg::SimpleLidar>();
}
