...
bool midterm_msgs__msg__control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("midterm_msgs.msg._control.Control", full_classname_dest, 33) == 0);
  }
  midterm_msgs__msg__Control * ros_message = _ros_message;
  {  // accel
...
PyObject * midterm_msgs__msg__control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("midterm_msgs.msg._control");
