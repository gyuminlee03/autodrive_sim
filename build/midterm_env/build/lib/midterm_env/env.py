...
class Car:
    ...
    def update_state(self, accel, steering, env):
        ...
        if self.check_collision_vehicle(env):
            ...
            env.num_collision += 1
            self.current_x = self.current_x - 1 * math.cos(self.current_yaw)
            self.current_y = self.current_y - 1 * math.sin(self.current_yaw)
...
class DrivingEnvironment(Node):
    ...
    def visualize(self):
        ...
        red_rect = plt.Polygon(self.car.v_rotated_corners , color='b')
